...
<div class="overflow-x-auto">
  <table class="min-w-full table-auto">
    <thead>
      <tr>
        <th class="px-4 py-2 bg-gray-600 text-white">ID</th>
        <th class="px-4 py-2 bg-gray-600 text-white">Name</th>
        <th class="px-4 py-2 bg-gray-600 text-white">Username</th>
        <th class="px-4 py-2 bg-gray-600 text-white">Email</th>
        <th class="px-4 py-2 bg-gray-600 text-white">Acciones</th>
      </tr>
    </thead>
    <tbody>
